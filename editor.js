document.addEventListener('DOMContentLoaded', () => {
    ...
    initializeEditorPage().catch(err => {
         ...
         document.body.innerHTML = `<div style="padding: 20px; color: red;"><h1>Initialization Error</h1><p>Could not load the editor environment. Please check the browser console for errors and try reloading.</p><pre>${escapeHtml(String(err))}</pre></div>`;
    });
});
